...
/* another sample Qubicle file */
static unsigned char const icebox_qb[] = {
  
};
/* the second sample, using RLE compression */
static unsigned char const icebox_rle_qb[] = {
  
};
...
int test_genrlematrix(void* q) {
  ...
  /* parse */do {
    if (len < 164)
      break;
    if (qbvoxel_parse_do(&st, 164, icebox_qb) != 164)
      break;
    if (qbvoxel_api_get_error(&st) != 0)
      break;
    if (qma->count != 1)
  ...
  if (res == EXIT_SUCCESS) {
    ...
    /* generate */do {
      if (sizeof(outbuf) < 200)
          break;
      if (qbvoxel_gen_do(&st, 200, outbuf) != rle_len)
        break;
      if (qbvoxel_api_get_error(&st) != 0)
        break;
      if (memcmp(outbuf, icebox_rle_qb, rle_len) != 0)
        break;
      res = EXIT_SUCCESS;
    } while (0);
    qbvoxel_gen_clear(&st);
